                ...
                <div class="gsap-card opacity-0 -translate-x-5 lg:col-span-1">
                    <div
                        ...
                        <p class="text-xs text-gray-400 mt-6">
                            ...
                            Update Terakhir: {{ $user->updated_at->diffForHumans() }}
                        </p>
                    </div>
                </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="gsap-input group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select name="role"
                                                class="block w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all font-medium text-gray-800 appearance-none cursor-pointer">
                                ...
                                <div class="gsap-input group">
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                                        Password Baru <span class="text-gray-400 font-normal text-xs ml-1">(Kosongkan
